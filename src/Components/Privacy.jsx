...
export default function PrivacyPolicyTheQrify({ effectiveDate = new Date().toISOString().slice(0, 10) }) {
  useEffect(() => {
    ...
    addLink("https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css", "bs5-theqrify");
    addLink("https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap", "inter-theqrify");
  }, []);
  ...
  return (
    <div style={{ background: "#fff", minHeight: "100vh" }}>
      <main className="py-5" style={style}>
          ...
          <header className="mb-4 text-center">
            ...
            <section id="how-use" className="mb-4">
              ...
              <ul>
                ...
                <li>Display relevant advertisements (future, with consent where required).</li>
            ...
            <section id="cookies" className="mb-4">
              ...
              <ul>
                ...
                <li>Serve advertisements in the future (non-personalized or personalized depending on consent).</li>
              </ul>
            ...
            <section id="ads" className="mb-4">
              <h2 className="h5 fw-bold">7. Advertisements (Future Feature)</h2>
              <p>In future versions, we may show ads such as:</p>
              <ul>
                <li>Banner ads</li>
                <li>Display ads</li>
                <li>Partner promotions</li>
              </ul>
              <p>Advertisements may use non-personalized or personalized data depending on your consent and browser settings. We will provide opt-outs and clear notices where legally required (e.g., GDPR).</p>
            </section>
