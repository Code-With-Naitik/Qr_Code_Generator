...
import Blog_News from "./Components/Blog_News.jsx";
...
import AdminQRTypes from "./admin/AdminQRTypes.jsx";
import AdminQRCodes from "./admin/AdminQRCodes.jsx";
...
function App() {
  ...
  return (
    <AdminProvider>
      ...
      {hideHeaderParam !== "true" && !location.pathname.startsWith("/admin") && <Navbar_1 />}
      {!location.pathname.startsWith("/admin") && <BottomToTop />}

      <main id="main-content" className={location.pathname.startsWith("/admin") ? "" : "no-select"}>
        <Routes>
          {/* ── Public routes ─────────────────────────────── */}
